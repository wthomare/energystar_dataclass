...
class ConvenienceStoreWithoutGasStationType:
    ...
    use_details: Optional[
        "ConvenienceStoreWithoutGasStationType.UseDetails"
    ] = field(
        default=None,
        metadata={
            "name": "useDetails",
...
class ConvenienceStoreWithoutGasStation(ConvenienceStoreWithoutGasStationType):
    """
    Buildings used for the sale of a limited range of items such as groceries,
    toiletries, newspapers, soft drinks, tobacco products, and other everyday
    items, which are not co-located with a gas station.
    """

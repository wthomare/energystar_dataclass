...
class StadiumOpenType:
    ...
    use_details: Optional["StadiumOpenType.UseDetails"] = field(
        default=None,
        metadata={
            "name": "useDetails",
            "type": "Element",
...
@dataclass
class StadiumOpen(StadiumOpenType):
    """Structures used primarily for professional or collegiate sports and
    entertainment events in which the playing field is.

    (Typically with a capacity of 5,000 seats or more)
    """

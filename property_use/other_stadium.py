...
class OtherStadiumType:
    ...
    use_details: Optional["OtherStadiumType.UseDetails"] = field(
        default=None,
        metadata={
            "name": "useDetails",
            "type": "Element",
...
class OtherStadium(OtherStadiumType):
    """
    Buildings primarily used for sporting events that do not meet the definition of
    any other property use defined in Portfolio Manager.
    """

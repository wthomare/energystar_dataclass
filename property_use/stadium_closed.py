...
class StadiumClosedType:
    ...
    use_details: Optional["StadiumClosedType.UseDetails"] = field(
        default=None,
        metadata={
            "name": "useDetails",
            "type": "Element",
...
@dataclass
class StadiumClosed(StadiumClosedType):
    """Structures with a permanent or retractable roof which are used primarily for
    professional or collegiate sports and entertainment events.

    (Typically with a capacity of 25,000 seats or more).
    """

...
class FoodSalesType:
    ...
    use_details: Optional["FoodSalesType.UseDetails"] = field(
        default=None,
        metadata={
            "name": "useDetails",
            "type": "Element",
...
class FoodSales(FoodSalesType):
    """
    Buildings used for the sales of food on either a retail or wholesale basis, but
    which do not meet the definition of Supermarket/Grocery Store, Convenience
    Store, or Convenience Store with Gas Station.
    """
